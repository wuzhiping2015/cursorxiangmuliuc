...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://D:/Project/AI_PROJECT/GE_REN_XIANGMU/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
...
import defu, { defuFn } from 'file://D:/Project/AI_PROJECT/GE_REN_XIANGMU/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
...
import { snakeCase } from 'file://D:/Project/AI_PROJECT/GE_REN_XIANGMU/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
...
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/Project/AI_PROJECT/GE_REN_XIANGMU/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000/.data/kv"}));
...
const rootDir = "D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000";
...
const getServerEntry = () => import('file://D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://D:/Project/AI_PROJECT/GE_REN_XIANGMU/10000/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
