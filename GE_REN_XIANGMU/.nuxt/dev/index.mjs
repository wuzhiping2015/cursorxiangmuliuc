...
import { Youch } from 'file://D:/Project/AI_PROJECT/GE_REN_XIANGMU/node_modules/.pnpm/youch@4.1.0-beta.8/node_modules/youch/build/index.js';
...
const _HLXp1amTt0R5qO97uQAe2xl5sbbCHZsWHWbTIg7zXw = (nitroApp) => {
...
const __TxeVMmXAYMVlBB4pJEP3rpkSf6ejPBPAszlbS0M2fc = defineNitroPlugin$1(async (nitro) => {
...
_HLXp1amTt0R5qO97uQAe2xl5sbbCHZsWHWbTIg7zXw,
__TxeVMmXAYMVlBB4pJEP3rpkSf6ejPBPAszlbS0M2fc,
...
const _Q5VpMr = eventHandler((event) => {
...
const _JJ3Hd4 = defineEventHandler(async (event) => {
...
const _2xH0EO = defineEventHandler(async (event) => {
...
const _urJfnX = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _lazy_3auEVq = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/query', handler: _JJ3Hd4, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _2xH0EO, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _urJfnX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _urJfnX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _urJfnX, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _i08qaz, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3auEVq, lazy: true, middleware: false, method: undefined }
];
